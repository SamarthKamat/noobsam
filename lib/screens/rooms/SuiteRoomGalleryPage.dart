...
class _SuiteRoomGalleryPageState extends State<SuiteRoomGalleryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> imageList = [
      'assets/images/STUD1.jpg',
      'assets/images/STUD2.jpg',
      'assets/images/STUD3.jpg',
      'assets/images/STUD4.jpg',
      'assets/images/STUD5.jpg',
      'assets/images/STUD6.jpg', // Add more images as needed
    ];
